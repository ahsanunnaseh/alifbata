...
//			samplingPanel.setBorder(new CompoundBorder(eb, sbb));
    ...
    public void getFileNameAndSaveFile() {
        ...
        wd.saveFileByteArray(saveFileName, audioBytes);
